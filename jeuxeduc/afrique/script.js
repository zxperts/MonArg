...
const locations = [
    ...
    // --- Afrique du Nord ---
    { key: 'tunisie',      country: 'Tunisie',      capital: 'Tunis',        x: 280, y: 96,  capitalPlacement: 'right'  },
    { key: 'libye',        country: 'Libye',        capital: 'Tripoli',      x: 330, y: 120, capitalPlacement: 'right'  },

    // --- Afrique de l'Ouest ---
    { key: 'mauritanie',   country: 'Mauritanie',   capital: 'Nouakchott',   x: 130, y: 190, capitalPlacement: 'right'  },
    { key: 'senegal',      country: 'Sénégal',      capital: 'Dakar',        x: 104,  y: 254, capitalPlacement: 'left'   },
    { key: 'mali',         country: 'Mali',         capital: 'Bamako',       x: 184, y: 194, capitalPlacement: 'right'  },
    ...
    { key: 'gambie',       country: 'Gambie',       capital: 'Banjul',       x: 85,  y: 252, capitalPlacement: 'left'   },
    { key: 'guineebissau', country: 'Guinée-Bissau', capital: 'Bissau',       x: 90,  y: 277, capitalPlacement: 'left'   },
    { key: 'guinee',       country: 'Guinée',       capital: 'Conakry',      x: 120,  y: 277, capitalPlacement: 'right'  },
    { key: 'sierraleone',  country: 'Sierra Leone', capital: 'Freetown',     x: 110,  y: 295, capitalPlacement: 'right'  },
    { key: 'liberia',      country: 'Libéria',      capital: 'Monrovia',     x: 125, y: 313, capitalPlacement: 'right'  },
    { key: 'cotedivoire',  country: 'Côte d\'Ivoire', capital: 'Yamoussoukro', x: 160, y: 315, capitalPlacement: 'right'  },
    { key: 'burkinafaso',  country: 'Burkina Faso', capital: 'Ouagadougou',  x: 198, y: 258, capitalPlacement: 'right'  },
