const translations = {
    fr: {
        ...
        hero: {
            title: "Bandundu Téléma",
            subtitle: "Association à but non lucratif - N° 0674 383 590"
        },
        about: {
    ...
    nl: {
        ...
        hero: {
            title: "Bandundu Téléma",
            subtitle: "Non-profit organisatie - Nr. 0674 383 590"
        },
        about: {
            title: "Over ons",
            mission: "Onze Missie",
        ...
        team: {
            title: "Ons Team",
            roles: {
                director: "Uitvoerend Directeur",
                coordinator: "Programmacoördinator",
                communication: "Communicatieverantwoordelijke"
            }
        },
        contact: {
    ...
    en: {
        ...
        hero: {
            title: "Bandundu Téléma",
            subtitle: "Non-profit organization - No. 0674 383 590"
        },
        about: {
            title: "About Us",
            mission: "Our Mission",
...
function updateTeamRoles() {
    const roles = translations[currentLanguage].team.roles;
    document.querySelectorAll('[data-member-role]').forEach(element => {
        const roleKey = element.getAttribute('data-member-role');
        if (roles[roleKey]) {
            element.textContent = roles[roleKey];
        }
    });
}
