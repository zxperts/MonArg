...
(function($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        this._name = widgetEvents;
        this._defaults = $.fn.widgetEvents.defaults;
    ...
    $.extend(Plugin.prototype, {
        ...
        initialContent: function(leagueDetailsAjaxURL, leagueId, widgetKey, leagueName, leagueLogo, timezone) {
            ...
            // Adding the "widgetEvents" class for styling and easyer targeting
            leagueLocation.addClass('widgetEvents');
                        ...
                        if (res.result) {
                            ...
                            $.each(groubedByTeam, function(key, value) {
                                ...
                                $.each(value, function(keys, values) {
                                    ...
                                    var dtMatch = new Date(values.event_date + ' ' + values.event_time);
            ...
            $.ajax({
                ...
                $('.widgetEvents .nav-tab').unbind('click').on('click', function(e) {
                    e.preventDefault();
                    //Toggle tab link
                ...
                $('.widgetEvents .standing-nav-tab-wrapper .nav-tab-wrapper').after(htmlInsideTabsConstructor);
                $('.widgetEvents .standing-nav-tab-wrapper .nav-tab').unbind('click').on('click', function(e) {
                    e.preventDefault();
                    //Toggle tab link
                    $(this).addClass('nav-tab-active').siblings().removeClass('nav-tab-active');
                    //Toggle target tab
    ...
    $.fn.widgetEvents = function(options) {
        this.each(function() {
            if (!$.data(this, "plugin_" + widgetEvents)) {
                $.data(this, "plugin_" + widgetEvents, new Plugin(this, options));
            }
        });
        return this;
    };

    $.fn.widgetEvents.defaults = {
