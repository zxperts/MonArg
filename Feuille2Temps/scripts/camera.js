...
let inputFeuille2temps_container = document.querySelector("#inputFeuille2temps_container");
...
camera_button.addEventListener('click', async function() {
    ...
    // hideButton();
    // $("#inputFeuille2temps_container").hide(250);
    // $("#cam_container").show(500);
    // camera_stop.style.display = 'block';
    // video.style.display = 'block';
    // camera_button.style.display = 'none';
    // inputFeuille2temps_container.style.display = 'none';
...
function hideButton() {    
    ...
    $("#inputFeuille2temps_container").hide();
    $("#cam_container").hide();
    $("#dataurl_container").hide();
}
function encoder() {
    // hideButton();
    // inputFeuille2temps_container.style.display = 'block';
}

$("#manuelInput").click(function(){
    $("#cam_container").hide()
    $("#dataurl_container").hide()
    $("#inputFeuille2temps_container").toggle(500);
});
